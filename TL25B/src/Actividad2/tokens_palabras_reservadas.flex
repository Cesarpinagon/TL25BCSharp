...
"("         { 
                ...
                /*return TokensTL24B.PAREN_APERTURA; */
            }

")"         { 
                System.out.print("Linea:"+(yyline+1)+", Columna:"+(yycolumn+1)+"\t");
                System.out.println(yytext()+" -> Paréntesis de cierre ");                
                /*return TokensTL24B.PAREN_CIERRE; */
            }
